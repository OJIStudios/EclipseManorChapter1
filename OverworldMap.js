    ...
    gameObjects: {
      ...
      artroom_puzzle: new Person({
        ...
        talking: [
          {
            events: [
              { type: "showPuzzle", url: "/puzzles/puzzle1.html", id: "puzzle1" },
              {
                type: "conditional",
    ...
    gameObjects: {
      ...
      livingroom_puzzle: new Person({
        ...
        talking: [
          {
            events: [
              { type: "showPuzzle", url: "/puzzles/puzzle4.html", id: "puzzle4" },
              {
                type: "conditional",
    ...
    gameObjects: {
      ...
      diningroom_puzzle: new Person({
        ...
        talking: [
          {
            events: [
              { type: "showPuzzle", url: "/puzzles/puzzle2.html", id: "puzzle2" },
              {
                type: "conditional",
    ...
    gameObjects: {
      ...
      kitchen_puzzle: new Person({
        ...
        talking: [
          {
            events: [
              { type: "showPuzzle", url: "/puzzles/puzzle3.html", id: "puzzle3" },
              {
                type: "conditional",
